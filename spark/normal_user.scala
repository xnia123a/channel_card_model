...
* nohup /opt/spark2/bin/spark-submit --class channel_card_model.normal_user /home/yimr/rfz/IoT.jar 20180401 > /home/yimr/rfz/nohup_all.txt
*/
  ...
  def main(args: Array[String]): Unit = {
    ...
    */
    ...
    val Usage_Detail_SMS_df = data_input_Usage_Detail_SMS
      ...
      .filter("acctID not in ('xxxxxxxxxxx','xxxxxxxxxxx','xxxxxxxxxxx','xxxxxxxxxxx','xxxxxxxxxxx','xxxxxxxxxxx')")
      .filter("SIM_State ='6'")
      .toDF()
    ...
    val wlw_user_df = spark.read.textFile(data_input_user)
      ...
      .filter("cust_name not in ('xxxxxxxxxxx','xxxxxxxxxxx','xxxxxxxxxxx')")
      .toDF()
    ...
    val data_output = hdfs_path + "xxxxxxxxxxx"
